...
public interface LiveTrackingRepository extends JpaRepository<LiveTrackingEntity, Long> {
    ...
    List<LiveTrackingEntity> findByReportPeriodStartGreaterThanEqualAndReportPeriodEndLessThanEqual(
